...
implements   ClassVisitor
{
    ...
    private static class DefaultDiagnosticsHandler implements DiagnosticsHandler
    {
        @Override
        ...
        {
            // Ignore warnings with respect to missing types for static interface desugaring.
            // This might happen if -multidex is enabled and the referenced program
            // class in stored in a different dex file. As long as we perform our
            // own multidexing this can not be solved. Also, DexGuard performs
            // static interface backporting itself, so it is redundant.
